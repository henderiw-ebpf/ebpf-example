...
type bpfProgramSpecs struct {
	XdpParserFunc      *ebpf.ProgramSpec `ebpf:"xdp_parser_func"`
	XdpPassFunc        *ebpf.ProgramSpec `ebpf:"xdp_pass_func"`
	XdpPortRewriteFunc *ebpf.ProgramSpec `ebpf:"xdp_port_rewrite_func"`
...
type bpfPrograms struct {
	XdpParserFunc      *ebpf.Program `ebpf:"xdp_parser_func"`
	XdpPassFunc        *ebpf.Program `ebpf:"xdp_pass_func"`
	XdpPortRewriteFunc *ebpf.Program `ebpf:"xdp_port_rewrite_func"`
